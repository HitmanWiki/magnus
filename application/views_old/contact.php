			...
			<div class="inner-page-wrapper">
				...
				<div class="row">	
					...
					<h3 class="h3-xs">Have Questions? Get in Touch</h3>
								<!-- Text -->	
<p class="p-md">Still, Have Any Queries then Don't Worry. We are here to help you 24*7. Leave your queries if you any and we will try to respond as soon as possible for better assistance.</p> 
					...
					<div class="contact-box icon-xs clearfix mb-25">
						<h3 class="darkblue-color pb-3" style="font-size:20px !important; font-weight:700; text-align: center;" ><u>India Office</u></h3>
									<!-- Icon -->	
							...
							<div class="contact-box-icons"><span class="fas fa-phone"></span></div>
							...
							<div class="contact-box-txt">
								...
								<!-- Icon -->	
							<div class="contact-box-icons"><span class="far fa-envelope-open"></span></div>
						...
						<div class="contact-box icon-xs clearfix mb-25">
						<h3 class="darkblue-color pb-3" style="font-size:20px !important; font-weight:700; text-align: center;" ><u>Canada Office</u></h3>
									<!-- Icon -->	
							<div class="contact-box-icon"><span class="flaticon-240-placeholder"></span></div>
										<!-- Text -->
							<div class="contact-box-txt">
											
									<h5 class="h5-sm deepblue-color" style="font-size:16px !important; font-weight:700;"> 1st Floor , Unit 12-1200 <br>Derry Rd E, </h5>
										<h5 class="h5-xs deepblue-color" style="font-size:16px !important;font-weight:700;"> Mississauga,<br>ON L5TOB3</h5>								
							</div>
							<div class="contact-box-icons"><span class="fas fa-phone"></span></div>

										<!-- Text -->
							<div class="contact-box-txt">
									<h5 class="h5-sm deepblue-color" style="font-size:16px !important;font-weight:700;">P: +1(416)605-4406</h5>		
							</div>	
							...
							<div class="contact-box-icons"><span class="far fa-envelope-open"></span></div>
										...
										<!-- Text -->
							<div class="contact-box-txt">
											<h5 class="h5-xs deepblue-color" style="font-size:16px !important;font-weight:700;"><a href="#"> info@magnusimmigration.ca</a></h5>
							</div>	


						</div>	
						<div class="contact-box icon-xs clearfix mb-25">
						<h3 class="darkblue-color pb-3" style="font-size:20px !important; font-weight:700; text-align: center;" ><u>Australia Office</u></h3>
									<!-- Icon -->	
							<div class="contact-box-icon"><span class="flaticon-240-placeholder"></span></div>
										<!-- Text -->
							<div class="contact-box-txt">
											
									<h5 class="h5-sm deepblue-color" style="font-size:16px !important; font-weight:700;"> 530 Little Collins Street,<br>  Level 2, Suit 215, <br>Melbourne, Victoria,<br> Australia 3000</h5>								
							</div>
							<div class="contact-box-icons"><span class="fas fa-phone"></span></div>

										<!-- Text -->
							<div class="contact-box-txt">
									<h5 class="h5-sm deepblue-color" style="font-size:16px !important;font-weight:700;">P: +61 455 381 217</h5>		
							</div>	
