...
$blog=$this->db->query("select * from tbl_blog_category where web_slug='$blogslug'");
		...
		<?php $this->load->view('inc/header.php');?>
			...
			<div class="inner-page-wrapper">
				...
				<div class="hero-txt white-color">
						<h2 class="h2-xs darkblue-color"><?php echo $blog_category['category'];?></h2>
								</div>
				...
				<section id="blog-page" class="wide-100 blog-page-section division">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
					 	<div class="row">
<?php $data_blog=$this->db->query("select * from tbl_blog where category=$blog_category[sno]");
