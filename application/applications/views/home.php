					...
					<div class="row">
							...
							<div class="sbox-4 icon-sm">
								<a href="<?php echo base_url('consultation');?>">
									...
									<div class="sbox-4-txt">
										...
										<p>Magnus caters an immense opportunity that allows you to get in touch with the Immigration experts over the phone or in person.</p>
									</div>
						...
						<div class="col-md-6 col-lg-4">
							...
							<a href="<?php echo base_url('pre-landing-and-post-landing-services');?>">
									...
									<!-- Text -->
									<div class="sbox-4-txt">
										<h5 class="h5-md darkblue-color">Pre Landing and Post Landing Services</h5>
